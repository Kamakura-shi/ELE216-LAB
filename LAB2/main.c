...
int main(int argc, char *argv[]) {
    ...
    // t_titre un_titre = get_tconst(un_titre);
    // un_titre->tconst = "Matrix";

    // ./main -t "Matrix" -c "movie" -a "1990:2000"

    // Lab2-HLR15 à HLR17 - Argument

    // La fonction définie au HLR09 doit écrire dans un deuxième fichier TSV tous les résultats de cotes
    int un_resultat_cote = t_resultat_ecrire(resultat, "title.ratings.tsv");
