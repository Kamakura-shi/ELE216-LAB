...
int main(int argc, char *argv[]) {
    ...
    if (argc < 2) {
        printf("Invalide! Pas assez de parametres!\n");
        return -1;
        // ...
        // À COMPLÉTER
        // ...
    ...
    t_resultat_ecrire(resultat, "title_basics.tsv");

    // tconst : titre-­>tconst = "The Matrix" : tt0133093

    t_titre titre_1 = creer_titre();
    t_titre titre_2 = creer_titre();
    t_titre titre_3 = creer_titre();

    t_resultat resultat_1 = creer_resultat();

    set_titre(titre_1,"The Matrix");
    set_genres(titre_1,"Action,Sci-Fi");

    add_titre(resultat_1,titre_1);
    add_titre(resultat_1,titre_2);
    add_titre(resultat_1,titre_3);
