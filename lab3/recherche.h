...
/**
* Mutateur de l'état de l'évaluation
*
* Permet d'ajouter l'état de l'évaluation
*
* critere : la structure a modifier
* a_evalue :  l'état de l'évaluation à ajouter
*/
void set_a_evalue(t_critere critere, int a_evalue);
...
/**
 * Observateur de l'état de l'évaluation
 *
 * Permet d'obtenir l'état de l'évaluation de la structure critere
 *
 * critere : la structure à observer
 *
 * Retour : indicateur constituant l'état de l'évaluation de la structure donnée
 *          en paramètre
 */
int get_a_evalue(t_critere critere)
